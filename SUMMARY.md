...
* [Queries & Syntax](altinity-kb-queries-and-syntax/README.md)
  * [Roaring bitmaps for calculating retention](altinity-kb-queries-and-syntax/roaring-bitmaps-for-calculating-retention.md)
...
* [Schema design](altinity-kb-schema-design/README.md)
  ...
  * [Dictionaries](altinity-kb-schema-design/altinity-kb-dictionaries/README.md)
    * [Dictionary on the top of the several tables using VIEW](altinity-kb-schema-design/altinity-kb-dictionaries/untitled.md)
    * [Example of PostgreSQL dictionary](altinity-kb-schema-design/altinity-kb-dictionaries/example-of-postgresql-dictionary.md)
    * [MySQL8 source for dictionaries](altinity-kb-schema-design/altinity-kb-dictionaries/mysql8-source-for-dictionaries.md)
    * [Partial updates](altinity-kb-schema-design/altinity-kb-dictionaries/partial-updates.md)
    * [range\_hashed example - open intervals](altinity-kb-schema-design/altinity-kb-dictionaries/altinity-kb-range_hashed-example-open-intervals.md)
    * [SPARSE\_HASHED VS HASHED](altinity-kb-schema-design/altinity-kb-dictionaries/altinity-kb-sparse_hashed-vs-hashed.md)
    * [Dictionaries & arrays](altinity-kb-schema-design/altinity-kb-dictionaries/dictionaries-and-arrays.md)
  * [Dictionaries vs LowCardinality](altinity-kb-schema-design/altinity-kb-dictionaries-vs-lowcardinality.md)
  * [Ingestion performance and formats](altinity-kb-schema-design/ingestion-performance-and-formats.md)
